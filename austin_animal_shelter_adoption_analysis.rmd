...
ggplot(data = adoption_data, mapping = aes(x = animalType, fill=gender)) +
...
Pickup where we left off looking at the dates and and create a month variable as well as a year variable. Then conduct eda and then do a machine learning model on the data.
